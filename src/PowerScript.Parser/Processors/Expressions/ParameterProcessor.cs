...
public class ParameterProcessor
{
    ...
    public (FunctionParametersToken Parameters, Token NextToken) ProcessParameters(Token startToken)
    {
        ...
        while (currentToken is not ParenthesisClosed)
        {
            ...
            if (TryProcessTypeAndIdentifier(currentToken, parameters, out Token? nextToken))
            {
    ...
    /// </summary>
    private static bool TryProcessTypeAndIdentifier(Token token, FunctionParametersToken parameters, out Token nextToken)
    {
