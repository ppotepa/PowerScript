...
namespace ppotepa.tokenez.Tree.Builders
{
    ...
    internal class FunctionCallProcessor : ITokenProcessor
    {
        ...
        public TokenProcessingResult Process(Token token, ProcessingContext context)
        {
            ...
            Console.WriteLine($"[DEBUG] FunctionCallProcessor: Processing function call '{token.RawToken?.Text}' in scope '{context.CurrentScope.ScopeName}'");
            Console.ResetColor();
            ...
            var statement = new FunctionCallStatement
            {
                ...
                StartToken = token,
                Arguments = new List<Token>() // Empty for now
            };
            ...
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine($"[DEBUG] FunctionCallProcessor: Added function call '{functionName}()' to scope '{context.CurrentScope.ScopeName}'");
            Console.ResetColor();
