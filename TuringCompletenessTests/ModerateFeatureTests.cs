...
namespace TuringCompletenessTests
{
    ...
    public class ModerateFeatureTests
    {
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_1_sum_of_numbers.ps");
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_2_conditional_counting.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_3_even_odd_sum.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_4_multiplication_table_sum.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_5_fibonacci.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_6_power_calculation.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_7_find_maximum.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_8_count_primes.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_9_complex_expressions.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
        ...
        {
            var script = File.ReadAllText("scripts/moderate/2_10_sum_and_product.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
