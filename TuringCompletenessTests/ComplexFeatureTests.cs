...
namespace TuringCompletenessTests
{
    ...
    public class ComplexFeatureTests
    {
        ...
        {
            var script = File.ReadAllText("scripts/complex/3_1_bubble_sort.ps");
        ...
        {
            var script = File.ReadAllText("scripts/complex/3_2_matrix_operations.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
        ...
        {
            var script = File.ReadAllText("scripts/complex/3_3_maze_solver.ps");
            Assert.DoesNotThrow(() => _interpreter.ExecuteCode(script));
